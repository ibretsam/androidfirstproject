...
public class ForgotPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgot_passworduser);
        final TextInputLayout account = (TextInputLayout) findViewById(R.id.Et_accountqmk);
        final TextInputLayout email = (TextInputLayout) findViewById(R.id.Et_emailqmk);
        ...
        bt_qmk.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String Account = account.getEditText().getText().toString();
...
//
    ...
    public void OpenCodeForgotPassword(String code){
        Toast.makeText(ForgotPassword.this, "Có cái account cũng để mất Bạn NGU vailon !!", Toast.LENGTH_SHORT).show();
    }
}
